//! Closeout test: launch the code-review-kit example end-to-end with
...
#[tokio::test]
async fn code_review_kit_resolves_all_role_skills() {
    let yaml = include_str!("../../../examples/code-review-kit/code-review-kit.swarmkit.yaml");
    let manifest = parse_yaml(yaml).expect("parse code-review-kit");
    ...
    .expect("launch code-review-kit with resolver");

    for role_id in ["reviewer", "security_auditor", "test_writer"] {
