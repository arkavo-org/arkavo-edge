...
impl AutoDiscovery {
    ...
    async fn detect_test_framework(
        &self,
    ...
    fn create_test_runner(
        ...
        Ok(match method {
            InjectionMethod::DynamicLibrary => {
                format!(
                    "DYLD_INSERT_LIBRARIES={}/libarkavo_bridge.dylib xcodebuild test",
                    self.project_root.display()
                )
            }
            InjectionMethod::RuntimeSwizzle => "arkavo test --swizzle".to_string(),
