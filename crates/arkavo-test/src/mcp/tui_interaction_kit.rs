...
use super::tui_keyboard_tools::TuiKeyboardKit;
use super::tui_screenshot_tool::TuiScreenshotKit;
...
impl TuiInteractionKit {
    ...
    async fn type_and_verify(
        ...
        let content = screenshot_result["content"]
            .as_str()
            .ok_or_else(|| TestError::Mcp("Failed to get screenshot content".to_string()))?;
    ...
    async fn verify_state(
        ...
        while attempt <= retry_count {
            ...
            if let Some(expected) = expected_content {
                if !last_content.contains(expected) {
