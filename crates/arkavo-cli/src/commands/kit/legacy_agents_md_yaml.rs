//! YAML/markdown value-extraction helpers for the legacy AGENTS.md parser
//! (`legacy_agents_md::parse_legacy_agents_md`). Split out of that module to
//! stay under the repo's per-file implementation-line limit; these helpers
//! have no callers outside the legacy parser.
...
pub(super) fn extract_yaml_value(line: &str, key: &str) -> Option<String> {
...
pub(super) fn parse_yaml_properties(
    line: &str,
    trimmed: &str,
